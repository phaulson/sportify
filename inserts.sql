...
insert into sp_follows values(3,2);
insert into sp_follows values(4,2);
insert into sp_follows values(5,2);
insert into sp_follows values(6,2);
insert into sp_follows values(7,2);
insert into sp_follows values(5,3);
insert into sp_follows values(4,3);
insert into sp_follows values(2,6);
insert into sp_follows values(3,5);
insert into sp_follows values(3,7);

insert into sp_subscription values(2, 3);
insert into sp_subscription values(2, 4);
insert into sp_subscription values(3, 5);

insert into sp_likes values(2,2);
insert into sp_likes values(2,3);
insert into sp_likes values(2,4);
insert into sp_likes values(2,5);
insert into sp_likes values(2,6);
insert into sp_likes values(2,7);
insert into sp_likes values(2,8);
insert into sp_likes values(3,3);
